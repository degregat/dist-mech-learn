...
If we want to keep the server from knowing the plaintext submissions, we have to adress three problems: how to compute the model update without knowing the plaintext gradients, how to ensure the clipping was done properly, and how to ensure the noising was done properly.
